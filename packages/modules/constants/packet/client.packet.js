export const CLIENT_PACKET = {
  ...
  lobby: {
    EnterLobbyRequest: 100, // 로비 진입 요청
    EnterLobbyResponse: 101, // 로비 진입 성공 응답 - 대기실 리스트 정보를 불러와서 보내줌
    UpdateSettingRequest: 102, // 설정 변경 요청
    UpdateSettingResponse: 103, // 설정 변경 저장에 따른 응답 - 추후 프리셋 / 롤백에 대비하여 미리 세팅값 저장
    EnterListOfRoomRequest: 104, // 대기실 리스트 진입 요청
    EnterListOfRoomResponse: 105, // 대기실 리스트 진입 성공 시 응답, 대기방 목록 리스트 보냄
    RefreshListOfRoomRequest: 106, // 대기실 리스트 새로고침 요청
    RefreshListOfRoomResponse: 107, // 대기실 리스트 새로고침 응답
    FilterRoomByHostUserRequest: 108, // 대기실 리스트 호스트 유저 필터 요청
    FilterRoomByHostUserResponse: 109, // 대기실 리스트호스트 유저 필터 응답, 해당 유저의 대기방 정보 보냄
    SearchRoomRequest: 110, // 대기실 리스트 검색 요청
    SearchRoomResponse: 111, // 대기실 리스트 검색 응답
    // 정렬은 추후 고려,
    CreateWaitingRoomRequest: 112, // 대기방 생성 요청
    CreateWaitingRoomResponse: 113, // 대기방 생성 응답
    CreateWaitingRoomNotification: 114, // 대기방 생성 알림 (전체 클라, 단 로비 서버에 접속해있는 유저만)
    JoinWaitingRoomRequest: 115, // 대기방 참가 요청
    JoinWaitingRoomResponse: 116, // 대기방 참가 응답, 해당 대기방에 속한 유저 정보 보냄
    // 이후 추가 필요
  },
};
