...
class C2GEventHandler extends BaseEvent {
  ...
  onData(socket, data) {
    ...
    while (socket.buffer.length >= config.header.client.typeLength + config.header.client.versionLength) {
      let offset = 0;
      ...
      const totalHeaderLength = config.header.client.typeLength + config.header.client.versionLength + versionLength + config.header.client.sequenceLength + config.header.client.payloadLength;
...
var onC2G_event_default = C2GEventHandler;
export {
  onC2G_event_default as default
};
//# sourceMappingURL=onC2G.event.js.map
